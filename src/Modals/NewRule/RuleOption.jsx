            ...
            >
                ...
                <div className=' flex justify-center items-center h-full w-full'>
                    <div className='bg-[#FFF] flex flex-col justify-center items-center h-[15.75rem]  w-[17.5rem] bg-opacity-70 text-black hover:cursor-pointer rounded-[1.25rem]'>
                        ...
                        <div className='font-Jomolhari mt-[0.31rem] text-[1.5rem]'>Write</div>
                        <div className='text-[1rem] mt-[0.63rem] text-center font-Jomolhari'>Write your own rule using <br></br> our rules writer</div>
                    </div>
                    ...
                    <div className='bg-[#FFF] flex flex-col justify-center items-center h-[15.75rem] w-[17.5rem] bg-opacity-70 text-black hover:cursor-pointer rounded-[1.25rem]' onClick={() => {
                        ...
                        <div className='font-Jomolhari mt-[0.31rem] text-[1.5rem]'>Upload</div>
                        <div className='text-[1rem] mt-[0.63rem] text-center font-Jomolhari'>Upload from your device <br></br> (.YML file)</div>
                    </div>
                </div>
            </Modal>
        </div>
