        ...
        <div className='flex flex-col  justify-start items-center w-[calc(100%-17.125rem)] h-full'>
            ...
            <div className='relative flex items-center h-[6.5rem] w-full bg-[#F8F9FA] '>
                ...
                <div className="relative">
                    <input type="text"
                        className=" text-[1.25rem] pl-10 pr-4 py-2 border border-[#8F8C8C] mt-[0.69rem] ml-[1.19rem] w-[29.5rem] h-[3.3125rem] rounded-[5.3125rem]"
                        placeholder="Search" />
                    <div className="absolute inset-y-9 left-4 pl-3  
                            flex items-center  
                            pointer-events-none">
                ...
                <div className='w-[15.1875rem] h-[3.8125rem] border rounded-[0.625rem] bg-secondary ml-[7.5rem] absolute right-[1.81rem] flex justify-center items-center'>
                    ...
                    <div className='text-[#FFF] text-[1.25rem] ml-[1.25rem] font-sem2' onClick={() => {
            ...
            <div className='flex flex-col h-[42.9375rem] w-[calc(100%-3.5rem)] mt-[2.25rem]'>
                <div><div className='h-[4.5625rem] rounded-t-[0.625rem] bg-[#EEE] flex justify-center items-center font-sem2 text-[1.25rem] text-[#000] w-full'>
