...
function CreateFlow({CurrentStep,selectedRules,setSelectedRules,config,setConfig,selectedRepo,setSelectedRepo}) {
    return (
        <div>
            {CurrentStep==1&&(<CreateFlow1 selectedRepo={selectedRepo} setSelectedRepo={setSelectedRepo}/>)}
